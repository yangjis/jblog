			...
			<div id="admin-content">
				...
				<table id="admin-cate-list">
					<colgroup>
		      		...
		      		<tbody id="cateList">
		      			<!-- 리스트 영역 -->
		      			<c:forEach var="vo" items="${requestScope.cataList}" varStatus="status">
		      			...
		      			<tr>
						    ...
						    <td class='text-center'>
						    	<img class="btnCateDel" src="${pageContext.request.contextPath}/assets/images/delete.jpg" data-no="${vo.cateNo }">
						    </td>
						</tr>
						</c:forEach>
